...
class Led
{
    ...
    /**
     * @ORM\Column(type="integer")
     * @Groups({"luminaire", "recipe","program"})
     */
    private $wavelength;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Channel", mappedBy="led", orphanRemoval=true)
     */
    private $channels;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Ingredient", mappedBy="led")
     */
    private $ingredients;
