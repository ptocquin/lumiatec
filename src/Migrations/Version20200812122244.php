 ...
 */
final class Version20200812122244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient AS SELECT id, led_id, recipe_id, level, pwm_start, pwm_stop FROM ingredient');
        ...
        $this->addSql('INSERT INTO ingredient (id, led_id, recipe_id, level, pwm_start, pwm_stop) SELECT id, led_id, recipe_id, level, pwm_start, pwm_stop FROM __temp__ingredient');
        ...
        $this->addSql('CREATE TABLE log (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, cluster_id INTEGER DEFAULT NULL, luminaire_id INTEGER DEFAULT NULL, controller_id INTEGER DEFAULT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, value CLOB NOT NULL COLLATE BINARY --(DC2Type:json_array)
        , comment VARCHAR(255) DEFAULT NULL COLLATE BINARY, time DATETIME NOT NULL, remote_id INTEGER NOT NULL, CONSTRAINT FK_8F3F68C5C36A3328 FOREIGN KEY (cluster_id) REFERENCES cluster (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8F3F68C5DC90A29E FOREIGN KEY (luminaire_id) REFERENCES luminaire (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8F3F68C5F6D1A74B FOREIGN KEY (controller_id) REFERENCES controller (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_8F3F68C5F6D1A74B ON log (controller_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, user_id, label, description, uuid, timestamp, frequency, color FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, uuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, timestamp INTEGER DEFAULT NULL, frequency DOUBLE PRECISION DEFAULT NULL, color VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_DA88B137A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO recipe (id, user_id, label, description, uuid, timestamp, frequency, color) SELECT id, user_id, label, description, uuid, timestamp, frequency, color FROM __temp__recipe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient AS SELECT id, led_id, recipe_id, level, pwm_start, pwm_stop FROM ingredient');
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('CREATE TABLE ingredient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, led_id INTEGER DEFAULT NULL, recipe_id INTEGER DEFAULT NULL, level INTEGER DEFAULT NULL, pwm_start DOUBLE PRECISION DEFAULT NULL, pwm_stop DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO ingredient (id, led_id, recipe_id, level, pwm_start, pwm_stop) SELECT id, led_id, recipe_id, level, pwm_start, pwm_stop FROM __temp__ingredient');
        $this->addSql('DROP TABLE __temp__ingredient');
        $this->addSql('CREATE INDEX IDX_6BAF7870B262EAC9 ON ingredient (led_id)');
        $this->addSql('CREATE INDEX IDX_6BAF787059D8A214 ON ingredient (recipe_id)');
        $this->addSql('DROP INDEX IDX_8F3F68C5C36A3328');
        $this->addSql('DROP INDEX IDX_8F3F68C5DC90A29E');
        $this->addSql('DROP INDEX IDX_8F3F68C5F6D1A74B');
        $this->addSql('CREATE TEMPORARY TABLE __temp__log AS SELECT id, cluster_id, luminaire_id, type, value, comment, time, remote_id FROM log');
        $this->addSql('DROP TABLE log');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, user_id, label, description, uuid, timestamp, frequency, color FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, uuid VARCHAR(255) DEFAULT NULL, timestamp INTEGER DEFAULT NULL, frequency DOUBLE PRECISION DEFAULT NULL, color VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, user_id, label, description, uuid, timestamp, frequency, color) SELECT id, user_id, label, description, uuid, timestamp, frequency, color FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
        $this->addSql('CREATE INDEX IDX_DA88B137A76ED395 ON recipe (user_id)');
        $this->addSql('DROP INDEX IDX_5076A4C0C36A3328');
