 ...
 */
final class Version20190818105624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE controller ADD COLUMN auth_token VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_A2F98E47DC90A29E ON channel (luminaire_id)');
        $this->addSql('CREATE INDEX IDX_A2F98E47B262EAC9 ON channel (led_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__controller AS SELECT id, url, name FROM controller');
        ...
        $this->addSql('INSERT INTO controller (id, url, name) SELECT id, url, name FROM __temp__controller');
