 ...
 */
final class Version20190815112407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__channel AS SELECT id, luminaire_id, channel, i_peek FROM channel');
        ...
        $this->addSql('INSERT INTO channel (id, luminaire_id, channel, i_peek) SELECT id, luminaire_id, channel, i_peek FROM __temp__channel');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__channel AS SELECT id, luminaire_id, channel, i_peek FROM channel');
        $this->addSql('DROP TABLE channel');
        $this->addSql('CREATE TABLE channel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, luminaire_id INTEGER NOT NULL, channel INTEGER NOT NULL, i_peek INTEGER NOT NULL)');
        $this->addSql('INSERT INTO channel (id, luminaire_id, channel, i_peek) SELECT id, luminaire_id, channel, i_peek FROM __temp__channel');
        $this->addSql('DROP TABLE __temp__channel');
        $this->addSql('CREATE INDEX IDX_A2F98E47DC90A29E ON channel (luminaire_id)');
        $this->addSql('DROP INDEX IDX_BFC1968BF6D1A74B');
