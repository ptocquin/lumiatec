 ...
 */
final class Version20190820163752 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, label, description FROM recipe');
        ...
        $this->addSql('INSERT INTO recipe (id, label, description) SELECT id, label, description FROM __temp__recipe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, label, description FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, label VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, label, description) SELECT id, label, description FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
    }
}
