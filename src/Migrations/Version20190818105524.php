 ...
 */
final class Version20190818105524 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__pcb');
        $this->addSql('CREATE INDEX IDX_46DC8952DC90A29E ON pcb (luminaire_id)');
        $this->addSql('ALTER TABLE user ADD COLUMN remote_token VARCHAR(255) DEFAULT NULL COLLATE BINARY');
    }
}
