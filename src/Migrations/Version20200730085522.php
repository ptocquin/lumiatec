 ...
 */
final class Version20200730085522 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, user_id, label, description, uuid, timestamp, frequency FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, uuid VARCHAR(255) DEFAULT NULL COLLATE BINARY, timestamp INTEGER DEFAULT NULL, frequency DOUBLE PRECISION DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_DA88B137A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO recipe (id, user_id, label, description, uuid, timestamp, frequency) SELECT id, user_id, label, description, uuid, timestamp, frequency FROM __temp__recipe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, user_id, label, description, uuid, timestamp, frequency FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, uuid VARCHAR(255) DEFAULT NULL, timestamp INTEGER DEFAULT NULL, frequency DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, user_id, label, description, uuid, timestamp, frequency) SELECT id, user_id, label, description, uuid, timestamp, frequency FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
        $this->addSql('CREATE INDEX IDX_DA88B137A76ED395 ON recipe (user_id)');
        $this->addSql('DROP INDEX IDX_5076A4C0C36A3328');
