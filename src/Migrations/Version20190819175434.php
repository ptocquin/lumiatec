 ...
 */
final class Version20190819175434 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE controller ADD COLUMN status INTEGER DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_A2F98E47DC90A29E ON channel (luminaire_id)');
        $this->addSql('CREATE INDEX IDX_A2F98E47B262EAC9 ON channel (led_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__controller AS SELECT id, url, name, auth_token FROM controller');
        $this->addSql('DROP TABLE controller');
        $this->addSql('CREATE TABLE controller (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, url VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, auth_token VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO controller (id, url, name, auth_token) SELECT id, url, name, auth_token FROM __temp__controller');
        $this->addSql('DROP TABLE __temp__controller');
        $this->addSql('DROP INDEX IDX_BFC1968BF6D1A74B');
        $this->addSql('DROP INDEX IDX_BFC1968BA76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__controller_user AS SELECT controller_id, user_id FROM controller_user');
        $this->addSql('DROP TABLE controller_user');
